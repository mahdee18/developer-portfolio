...
const Navbar = () => {
    ...
    return (
        <nav className="flex border-b border-gray-50/10 items-center justify-between px-4 py-3 relative">
            {/* Logo */}
            ...
            <div className="md:hidden">
                ...
                >
                    {isOpen ? <IoMdClose color="white" size={24} /> : <CiMenuFries color="white" size={24} />}
                </button>
            </div>
